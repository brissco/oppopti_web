...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          <label for="photo" class="col-form-label">Logo <span class="text-danger">*</span></label>
          <div class="input-group">
            <input class="form-control" type="file" name="logo" value="<?php echo e($data->logo); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <input class="form-control" type="file" name="photo"  value="<?php echo e($data->photo); ?>">
            <div class="input-group-append">
            </div>
          </div>
          <div id="holder" style="margin-top:15px;max-height:100px;"></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/backend/setting.blade.php ENDPATH**/ ?>