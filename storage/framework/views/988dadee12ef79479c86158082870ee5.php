...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name="is_featured" id="is_featured" value="1" <?php echo e($product->is_featured ? 'checked' : ''); ?>> Yes
        </div>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
              ...
              <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
              <option value="S" <?php echo e(in_array("S", $data) ? 'selected' : ''); ?>>Small</option>
              <option value="M" <?php echo e(in_array("M", $data) ? 'selected' : ''); ?>>Medium</option>
              <option value="L" <?php echo e(in_array("L", $data) ? 'selected' : ''); ?>>Large</option>
              <option value="XL" <?php echo e(in_array("XL", $data) ? 'selected' : ''); ?>>Extra Large</option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
...
<!--<link rel="stylesheet" href="<?php echo e(asset('public/backend/summernote/summernote.min.css')); ?>">-->
<!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstrap-select.css" />-->

<?php $__env->stopPush(); ?>
<?php $__env->startPush('scripts'); ?>
<!--<script src="/vendor/laravel-filemanager/js/stand-alone-button.js"></script>-->
<!--<script src="<?php echo e(asset('public/backend/summernote/summernote.min.js')); ?>"></script>-->
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/backend/product/edit.blade.php ENDPATH**/ ?>