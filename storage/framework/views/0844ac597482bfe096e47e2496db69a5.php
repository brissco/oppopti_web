                    ...
                    <td>
                     <ul style="list-style:none" class="d-flex">
                          ...
                          <?php if($review->rate >=$i): ?>
                            <li style="float:left;color:#c90011;"><i class="fa fa-star"></i></li>
                          <?php else: ?>
                            <li style="float:left;color:#c90011;"><i class="far fa-star"></i></li>
                          <?php endif; ?>
                        <?php endfor; ?>
                     </ul>
                    </td>
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/user/review/index.blade.php ENDPATH**/ ?>