    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <?php else: ?>
            <img class="img-profile rounded-circle" src="<?php echo e(asset('public/backend/img/avatar.png')); ?>">
          <?php endif; ?>
        </a>
...
<?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/backend/layouts/header.blade.php ENDPATH**/ ?>