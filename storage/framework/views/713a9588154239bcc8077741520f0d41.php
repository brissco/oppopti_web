          ...
          <div class="col-lg-6 col-lx-4">
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                      <td>Coupon</td>
                      <td> : XAF  <?php echo e(number_format($order->coupon,2)); ?></td>
                    </tr>
                    <tr>
                        <td>Total Amount</td>
                        <td> : XAF  <?php echo e(number_format($order->total_amount,2)); ?></td>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/backend/order/show.blade.php ENDPATH**/ ?>