...
<?php $__env->startSection('title','Mixmoda Shop || HOME PAGE'); ?>
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                ?>
                                <?php if($categories): ?>
                                <button class="btn" style="background:#002ea3; color:white !important;"data-filter="*">
                                    All Products
                                </button>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <button class="btn" style="background:none;color:#002ea3;"data-filter=".<?php echo e($cat->id); ?>">
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#<?php echo e($product->id); ?>" title="Quick View" href="#"><i class=" ti-eye"></i><span>Aperçu rapide</span></a>
                                                    <a title="Wishlist" href="<?php echo e(route('add-to-wishlist',$product->slug)); ?>" ><i class=" ti-heart "></i><span>Ajouter à la liste de souhaits</span></a>
                                                </div>
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a href="<?php echo e(route('add-to-cart',$product->slug)); ?>">Ajouter au panier</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
                                <h3><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->title); ?></a></h3>
                                <div class="product-price">
                                    <span class="old">XAF <?php echo e(number_format($product->price * $amount,2)); ?></span>
                                    <?php
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    ?>
                                    <span>XAF <?php echo e(number_format($after_discount * $amount,2)); ?></span>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">XAF <?php echo e(number_format($product->discount,2)); ?></p>
                                    </div>
                                </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/frontend/index.blade.php ENDPATH**/ ?>