            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              ?>
                <tr>
                    ...
                    <td><?php echo e(isset($product->cat_info->title) ? $product->cat_info->title : ""); ?>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset('public/backend/img/thumbnail-default.jpg')); ?>" class="img-fluid" style="max-width:80px" alt="avatar.png">
                        <?php endif; ?>
                    </td>
                    <td>
...
<?php $__env->startPush('styles'); ?>
  <link href="<?php echo e(asset('public/backend/vendor/datatables/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet">
...
<?php $__env->startPush('scripts'); ?>
  ...
  <!-- Page level plugins -->
  <script src="<?php echo e(asset('public/backend/vendor/datatables/jquery.dataTables.min.js')); ?>"></script>
  <script src="<?php echo e(asset('public/backend/vendor/datatables/dataTables.bootstrap4.min.js')); ?>"></script>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/backend/product/index.blade.php ENDPATH**/ ?>