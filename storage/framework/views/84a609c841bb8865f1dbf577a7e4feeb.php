<?php $__env->startSection('title', 'Mixmoda Shop || Page d\'inscription'); ?>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2>Inscription</h2>
                        <p>Veuillez vous inscrire pour passer votre commande plus rapidement</p>
                        <!-- Formulaire -->
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <a href="<?php echo e(route('login.form')); ?>" class="btn">Connexion</a>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/etienne/Bureau/ffg-afrique-web-site/resources/views/frontend/pages/register.blade.php ENDPATH**/ ?>